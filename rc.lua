...
gui_editor = "mousepad"
terminal = "alacritty" --os.getenv("TERMINAL") or "alacritty"
-- local layouts = lain.layout.uselessfair
-- layouts
...
-- {{{ Mouse bindings
root.buttons(gears.table.join(awful.button({}, 1, function() mymainmenu:hide() end),
